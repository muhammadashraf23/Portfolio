...
const Education = () => {
  return (
    <section id="education" className="py-20 z-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(0,0,0,0.02),transparent_50%)] z-0" />
          ...
          {education.map((item, index) => (
            ...
            >
              ...
              <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-accent-purple-500/50 via-accent-cyan-500/50 to-accent-purple-500/50 shadow-glow-purple group-hover:shadow-glow-cyan transition-all duration-500">
                ...
                {/* Inner Card */}
                <div className="bg-background rounded-2xl p-6 md:p-8 h-full w-full flex flex-col justify-between hover:bg-zinc-200 transition-all duration-500 relative overflow-hidden">
