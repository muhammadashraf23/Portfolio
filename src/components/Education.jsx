          ...
          {education.map((item, index) => (
            ...
            >
              ...
              <div className="relative p-[2px] rounded-2xl bg-gradient-to-r from-accent-purple-500/50 via-accent-cyan-500/50 to-accent-purple-500/50 shadow-glow-purple group-hover:shadow-glow-cyan transition-all duration-500">
                ...
                {/* Inner Card */}
                <div className="bg-background rounded-2xl p-8 h-full w-full flex flex-col justify-between hover:bg-[#0a0520] transition-all duration-500 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl mb-4 font-semibold">
