...
const Projects = () => {
  return (
    <section id="projects" className="py-20 text-white relative z-20 overflow-hidden">
                ...
                <div className="relative h-full glass-card rounded-2xl overflow-hidden hover:border-accent-cyan-500 transition-all duration-500 hover:scale-[1.02] shadow-glow-purple">
                  ...
                  <div className="relative overflow-hidden">
                    <img
                      src={project.image}
                      alt={project.title}
                      className="w-full h-48 object-cover object-top opacity-90 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500"
                    />
                  ...
                  <div className="p-6 relative z-20">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, i) => (
                          <li
                            key={i}
                            className="bg-accent-purple-500/20 border border-accent-purple-500/50 text-accent-cyan-300 px-3 py-1 rounded-full text-xs font-semibold"
                          >
                            {tech}
                          </li>
                        ))}
                    ...
                    <div className="flex gap-3 mt-6">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 px-4 py-2 border-2 border-accent-purple-500/50 hover:bg-accent-purple-900/30 hover:border-accent-cyan-500 text-white rounded-lg text-sm transition-all hover:scale-105 text-center font-semibold"
                      >
                        GitHub
                      </a>
                    </div>
